...
public class LancamentoCartaoResource {
    ...
    public LancamentoCartaoResource(LancamentoCartaoRepository lancamentoCartaoRepository) {
    ...
    public ResponseEntity<LancamentoCartao> createLancamentoCartao(@Valid @RequestBody LancamentoCartao lancamentoCartao) throws URISyntaxException {
        ...
        LancamentoCartao result = lancamentoCartaoRepository.save(lancamentoCartao);
    ...
    public ResponseEntity<List<LancamentoCartao>> getAllLancamentoCartaos(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
        log.debug("REST request to get a page of LancamentoCartaos");
        Page<LancamentoCartao> page = lancamentoCartaoRepository.findAll(pageable);
    ...
    public ResponseEntity<LancamentoCartao> getLancamentoCartao(@PathVariable Long id) {
        ...
        Optional<LancamentoCartao> lancamentoCartao = lancamentoCartaoRepository.findById(id);

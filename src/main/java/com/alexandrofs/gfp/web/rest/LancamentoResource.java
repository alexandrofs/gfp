...
public class LancamentoResource {
    ...
    public ResponseEntity<List<Lancamento>> getAllLancamentos(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

...
public class IndiceSerieDi implements Serializable {
    ...
    @NotNull
    @Column(name = "fator_diario", precision=10, scale=8, nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        if (indiceSerieDi.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, indiceSerieDi.id);
    }

(function() {
    ...
    InvestimentoDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Investimento', 'Carteira', 'TipoInvestimento', 'HistoricoCotas', 'Instituicao'];

    function InvestimentoDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Investimento, Carteira, TipoInvestimento, HistoricoCotas, Instituicao) {
        var vm = this;

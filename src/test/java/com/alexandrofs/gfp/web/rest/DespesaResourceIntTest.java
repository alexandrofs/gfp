...
/**
 * Test class for the DespesaResource REST controller.
 *
 * @see DespesaResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = GfpApp.class)
public class DespesaResourceIntTest {
    ...
    public static Despesa createEntity(EntityManager em) {
        ...
        // Add required entity
        CategoriaDespesa categoriaDespesa = CategoriaDespesaResourceIntTest.createEntity(em);

...
/**
 * Integration tests for the {@Link CategoriaDespesaResource} REST controller.
 */
@SpringBootTest(classes = GfpApp.class)
public class CategoriaDespesaResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static CategoriaDespesa createUpdatedEntity(EntityManager em) {
        CategoriaDespesa categoriaDespesa = new CategoriaDespesa()
            .nome(UPDATED_NOME)
